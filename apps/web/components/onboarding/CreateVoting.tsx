...
export const CreateVoting = (props: any) => {
              ...
              >
                <Stack spacing='8'>
                  <HStack spacing='3' width='40'>
                    {[...Array(6)].map((_, id) => (
                      <Step key={1} cursor='pointer' isActive={5 === id} />
                    ))}
                  </HStack>
                  <Stack spacing='4'>
                    <Badge
                    ...
                    >
                      <Stack spacing='3'>
                        ...
                        <Text
                          ...
                          color='gray'
                        >
                          Governance tokens, which are obtained by depositing
                          funds, are used to vote with 1 token equaling 1 vote.
                        </Text>
                      </Stack>
